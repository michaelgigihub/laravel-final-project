...
import { Calendar, Check, ClipboardList, Pencil, User, X } from 'lucide-react';
...
interface TreatmentRecord {
    ...
    teeth: Array<{ id: number; name: string }>;
    created_at: string;
}
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Treatments performed or scheduled for this appointment
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
